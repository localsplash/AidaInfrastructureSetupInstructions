...
CREATE DATABASE IF NOT EXISTS aida_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON aida_db.* TO 'aida_runtime'@'%';
GRANT ALL PRIVILEGES ON aida_admin_db.* TO 'aida_admin'@'%';
GRANT SELECT ON aida_db.* TO 'aida_runtime_reader'@'%';
SQL
)
