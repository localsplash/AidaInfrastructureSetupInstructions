...
- Run MySQL migrations and NocoDB `PlatformConfig` initialization
...
[Platform data standard](https://github.com/localsplash/AidaInfrastructureSetupInstructions/blob/main/docs/PLATFORM_DATA_STANDARD.md)
